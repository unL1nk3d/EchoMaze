...
## Documentation Tips
- For more context go to the file `kanvan.md` wichs describes the current user stories/tasks that are under development
- The `work.md` represents a historical large file that involves the sdd workflow used on the development of the application 
